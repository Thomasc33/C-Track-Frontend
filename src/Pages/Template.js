                    ...
                    {isAdmin || (permissions && (permissions.use_importer || permissions.view_jobcodes || permissions.view_users)) ? < li >
                        <div className='dropDownHeader'>
                            ...
                            <div className='dropdown-content'>
                                ...
                                {isAdmin || (permissions && permissions.view_jobcodes) ?
                                    <p style={{ ':hover': { background: localStorage.getItem('accentColor') || '#524e00' } }} onClickCapture={(e) => props.history.push('/parts')}>Part Management</p> : <></>}
                                {isAdmin || (permissions && permissions.view_jobcodes) ?
                                    <p style={{ ':hover': { background: localStorage.getItem('accentColor') || '#524e00' } }} onClickCapture={(e) => props.history.push('/parttypes')}>Part Types</p> : <></>}
