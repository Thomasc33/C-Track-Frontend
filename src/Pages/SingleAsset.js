        ...
        return <>
            ...
            <div><h1>{search} not found</h1>
                {props.permissions.edit_models || props.isAdmin ? <div>
                    ...
                    <br />
                    <Button variant='contained' color='primary' size='large' style={{ padding: '1rem', backgroundColor: localStorage.getItem('accentColor') || '#e67c52' }} onClick={() => { handleAssetAdding() }}>Add</Button>
                </div>
                    : <></>
                }
            </div>
                    ...
                    modelInfo ?
                        <div>
                            <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                                {results.length > 0 ? <Button variant='contained' color='primary' size='large' style={{ padding: '1rem', backgroundColor: localStorage.getItem('accentColor') || '#e67c52' }} onClick={() => { setModelInfo(null) }}>Back</Button> : <></>}
                                <h1>Model Information: {modelInfo.info.model_number}</h1>
                                {results.length > 0 ? <Button variant='contained' color='primary' size='large' style={{ padding: '1rem', backgroundColor: localStorage.getItem('accentColor') || '#e67c52' }} onClick={() => { nextAsset() }}>Next</Button> : <></>}
                            </div>
                            <hr />
                        ...
                        !asset ? results.length > 0 ? <div>
                            ...
                            asset.notFound ?
                                ...
                                : <div style={{ overflow: 'scroll' }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                                        {results.length > 0 ? <Button variant='contained' color='primary' size='large' style={{ padding: '1rem', backgroundColor: localStorage.getItem('accentColor') || '#e67c52' }} onClick={() => { setHistory([]); setAsset(null); setRepairHistory([]) }}>Back</Button> : <></>}
