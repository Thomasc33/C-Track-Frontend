...
function HomePage(props) {
    ...
    function renderTasks(row) {
        ...
        if (row.percentComplete) background = `linear-gradient(90deg, ${localStorage.getItem('accentColor') || '#524e00'} 0%, ${blendColors(localStorage.getItem('accentColor') || '#e3de00', '#1b1b1b', .9)} ${row.percentComplete}%, #1b1b1b 100%)`
